  ...
  data: function() {
    return {
      ...
      crzdata: {
        ...
        urelation: "非业主(承租人)",
        txImg: "./files/frontImgs/crz/tx/"+this.$route.params.txImg+".jpg"
      }
    };
  },
  methods: {
    toFront() {
      this.$router.push("/crz/front");
    },
    testOpen() {
      console.log(this.$route.params.username);
      this.$message(this.$route.params.username);
    }
  },
...
<style scoped>
.ms-wrap {
  /* background-image: url('../../assets/img/crz/crz-bg.jpg');
